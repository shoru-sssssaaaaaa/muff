...
private fun catalogSourcesPath() =
    PathItem().apply {
        get =
            Operation().apply {
                tags = listOf("Catalog")
...
private fun feedResponses(okDescription: String) =
    ApiResponses().apply {
        addApiResponse(
            "200",
            ApiResponse().apply {
